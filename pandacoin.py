...
def mine_block ():
    ...
    transactions = blockchain.add_transactions(sender = node_address, receiver='ME', amount = 1)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The PandaCoin Blockchain contain the following nodes',
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        response = {'message':'This chain is the longest one!',
